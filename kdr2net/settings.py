...
if DEBUG:
    ...
    DATABASE_NAME = os.path.join(os.path.dirname(os.path.abspath(__file__)),'data/sqlite3.dat')
...
SECRET_KEY = 'dd&y3ngik(&qu2x2+w7@ga&)r^)mhg-ddohe=!!2v2uximskhe'
